...
public final class SpatialGridBuffers {
    ...
    public void init(int initialParticleCount, int initialCellCount) {
    ...
    public void ensureCapacity(int requiredParticles, int requiredCells) {
    ...
    public int[] readCounts(int cellCount) {
        return readIntBuffer(countsSsbo, cellCount);
    }

    public int[] readParticleIds(int particleCount) {
