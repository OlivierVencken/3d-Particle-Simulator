...
import com.particle.sim.particles.spawning.ParticleSpawner;
...
public final class ParticleBuffers {
    ...
    public int positionSsbo() {
        return positionSsbo;
    }

    public int velocitySsbo() {
        return velocitySsbo;
    }
    ...
    public float[] readPositions(int particleCount) {
        return readFloatBuffer(positionSsbo, particleCount);
    }

    public float[] readVelocities(int particleCount) {
        return readFloatBuffer(velocitySsbo, particleCount);
    }

    public void replaceState(float[] positions, float[] velocities) {
