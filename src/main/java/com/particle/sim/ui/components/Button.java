...
public final class Button {
    ...
    public static boolean text(
            String label, String id, ComponentVariant variant, float width, float height) {
    ...
    public static boolean icon(
            String accessibleLabel, String id, long textureId, boolean selected, boolean enabled) {
