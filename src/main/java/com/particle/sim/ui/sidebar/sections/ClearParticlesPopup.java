    ...
    protected void renderContent() {
        ...
        try {
            ImGui.textUnformatted(
                    "Remove %,d particles from the simulation?".formatted(particleCount));
            ImGui.textDisabled(
                    "This cannot be undone, but new particles can be spawned afterwards.");
