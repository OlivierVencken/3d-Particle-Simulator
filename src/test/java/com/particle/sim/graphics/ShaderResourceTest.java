...
class ShaderResourceTest {
    ...
    void shaderResourcesArePackagedWithExpectedEntrypoints() throws IOException {
        assertShaderContains(
                "/shaders/particle.comp", "layout(local_size_x = 256) in;", "void main()");
        ...
        assertShaderContains(
                "/shaders/bloom_extract.frag", "uniform sampler2D uScene;", "void main()");
        assertShaderContains(
                "/shaders/blur.frag", "uniform float uRadius;", "1.384615", "void main()");
        assertShaderContains(
                "/shaders/bloom_composite.frag", "uniform sampler2D uBloom;", "void main()");
        assertShaderContains(
                "/shaders/trail.vert",
