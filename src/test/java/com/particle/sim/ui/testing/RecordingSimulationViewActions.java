...
public final class RecordingSimulationViewActions implements SimulationViewActions {
    ...
    @Override
    public SimulationActions simulation() {
        return simulation;
    }
    ...
    public final class ParticleActions implements SimulationViewActions.Particles {
        ...
        public void setGroupCount(int value) {
            record("particles.groupCount");
        }

        @Override
        public void setSpawnMode(SpawnMode value) {
            record("particles.spawnMode");
        }

        @Override
        public void add(int amount) {
            record("particles.add");
        }

        @Override
        public void remove(int amount) {
            record("particles.remove");
        }
    ...
    public final class VisualActions implements SimulationViewActions.Visuals {
        ...
        public void setPointSize(float value) {
            record("visuals.pointSize");
        }

        @Override
        public void setFixedParticleScreenSize(boolean value) {
            record("visuals.fixedScreenSize");
        }
        ...
        @Override
        public void setEffectEnabled(EffectMode mode, boolean enabled) {
            record("visuals.effect");
        }

        @Override
        public void setGlowBlurPasses(int value) {
            record("visuals.glowBlurPasses");
        }

        @Override
        public void setGlowStrength(float value) {
            record("visuals.glowStrength");
        }

        @Override
        public void setGlowRadius(float value) {
            record("visuals.glowRadius");
        }

        @Override
        public void setGlowFalloff(float value) {
            record("visuals.glowFalloff");
        }

        @Override
        public void setTrailLength(int value) {
            record("visuals.trailLength");
        }

        @Override
        public void setTrailThickness(float value) {
            record("visuals.trailThickness");
        }
    }
    ...
    public final class CameraActions implements SimulationViewActions.Camera {
        ...
        public void setSensitivity(float value) {
            record("camera.sensitivity");
        }

        @Override
        public void setFlySpeed(float value) {
            record("camera.flySpeed");
        }
    ...
    public final class ApplicationActions implements SimulationViewActions.Application {
        ...
        public void setFpsCap(int value) {
            record("application.fpsCap");
        }

        @Override
        public void resetSettings() {
            record("application.resetSettings");
        }

        @Override
        public void savePreset() {
            record("application.savePreset");
        }

        @Override
        public void loadPreset() {
            record("application.loadPreset");
        }

        @Override
        public void hideUi() {
            record("application.hideUi");
        }
